...
void    Build_lvl_1(SDL_Renderer *renderer)
{
    ...
    main_wall_1.spriteData.texture = loadTexture("..\\..\\Source\\Sprites\\main_wall(111).bmp");
    main_wall_2.spriteData.texture = loadTexture("..\\..\\Source\\Sprites\\main_wall(138).bmp");
    main_wall_3.spriteData.texture = loadTexture("..\\..\\Source\\Sprites\\main_wall(111).bmp");
    main_wall_4.spriteData.texture = loadTexture("..\\..\\Source\\Sprites\\main_wall(138).bmp");
    main_wallAngle1.spriteData.texture = loadTexture("..\\..\\Source\\Sprites\\main_wallAngle(109).bmp");
    main_wallAngle2.spriteData.texture = loadTexture("..\\..\\Source\\Sprites\\main_wallAngle(110).bmp");
    main_wallAngle3.spriteData.texture = loadTexture("..\\..\\Source\\Sprites\\main_wallAngle(136).bmp");
    main_wallAngle4.spriteData.texture = loadTexture("..\\..\\Source\\Sprites\\main_wallAngle(137).bmp");
